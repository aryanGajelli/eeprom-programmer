...
// Si5351 I2C address shifted for STM32 HAL I2C APIs
...
HAL_StatusTypeDef setupPLL(Si5351PLL_t pll, uint8_t mult, uint32_t num, uint32_t denom);
HAL_StatusTypeDef setupPLLInt(Si5351PLL_t pll, uint8_t mult);
HAL_StatusTypeDef setupMultisynth(uint8_t output, Si5351PLL_t pllSource, uint32_t div, uint32_t num, uint32_t denom);
HAL_StatusTypeDef setupMultisynthInt(uint8_t output, Si5351PLL_t pllSource, Si5351MultisynthDiv_t div);
